...
async def home(x_currency: str = Header(os.getenv("DEFAULT_CURRENCY")),accept_language: str = Header("en"),) -> Response[HomeResponseDto]:
    return await service.home_v2(x_currency,accept_language)