...
class CallbackService:
    ...
    async def __run_one_sync_internal(self, bundle_id: str, operation: str, reseller_id: str = None):
        try:
            if reseller_id and reseller_id == get_config("RESELLER_ID"):
                await self._handle_reseller_operations(operation, bundle_id, reseller_id)
    ...
    async def _handle_reseller_operations(self, operation: str, bundle_id: str, reseller_id: str):
        if operation == "delete":
